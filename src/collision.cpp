...
double determine_effective_radius_for_collision(double radius, int stellar_type, int integration_flag)
{
    ...
    {
        /* [P5.2] Apply enlarged collision radius only to NS (type 13) and BH (type 14).
         * This is an intentional numerical fudge to prevent excessively long final inspirals
         * during NS/BH mergers (computationally expensive). WDs (types 10-12) use their
         * physical radii and must NOT have this factor applied. */
